...
class Shelf extends THREE.Object3D {
  ...
  constructor(length, height, width, boxLength, boxHeight, boxWidht, boxThickness, x, y, z) {
    ...
    // First Floor
    this.first = Shelf.createMesh(new THREE.CubeGeometry(length, 1, width));
    this.first.translateX(x);
    this.first.translateY(y + 5);
    this.first.translateZ(z);
    this.firstBox1 = new Box(boxLength, boxHeight, boxWidht, boxThickness, this.first.position.x, this.first.position.y + 0.5, this.first.position.z + (width / 2 - boxWidht / 2));
    this.firstBox2 = new Box(boxLength, boxHeight, boxWidht, boxThickness, this.first.position.x, this.first.position.y + 0.5, this.first.position.z + (this.firstBox1.position.z - boxWidht / 3) - boxThickness);
    ...
    // Second Floor
    this.second = Shelf.createMesh(new THREE.CubeGeometry(length, 1, width));
    this.second.translateX(x);
    this.second.translateY(y + (height / 2) + 5);
    this.second.translateZ(z - length / 2);
    this.secondBox1 = new Box(boxLength, boxHeight, boxWidht, boxThickness, this.second.position.x, this.second.position.y + 0.5, this.second.position.z + (width / 2 - boxWidht / 2));
    this.secondBox2 = new Box(boxLength, boxHeight, boxWidht, boxThickness, this.second.position.x, this.second.position.y + 0.5, this.second.position.z + (this.secondBox1.position.z - boxWidht / 3) - boxThickness);
    ...
    // Third Floor
    this.third = Shelf.createMesh(new THREE.CubeGeometry(length, 1, width));
    this.third.translateX(x);
    this.third.translateY(y + height + 6);
    this.third.translateZ(z - (length / 2.5));
    this.thirdBox1 = new Box(boxLength, boxHeight, boxWidht, boxThickness, this.third.position.x, this.third.position.y + 0.5, this.third.position.z - (width / 2 - boxWidht / 2));
    this.thirdBox2 = new Box(boxLength, boxHeight, boxWidht, boxThickness, this.third.position.x, this.third.position.y + 0.5, this.third.position.z - (this.thirdBox1.position.z - boxWidht / 3) + boxThickness);
